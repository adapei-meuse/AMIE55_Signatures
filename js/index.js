...
const POLES_ARRAY = [
  ...
  pairactifs = { lib: "Pairs'Actifs", color: SEPARATOR_COLORS.ADAPEI, src :"pairsactifs.png"},
  diocese = { lib: "Diocèse", color : SEPARATOR_COLORS.DIOCESE, src:  "diocese.png", hidden: true, domaine: "@catholique55.fr"},
  mda = { lib: "Maison des Adolescents", color : SEPARATOR_COLORS.ADAPEI, src:  "mda.jpg", hidden: true, domaine: "@mda55.fr"},
